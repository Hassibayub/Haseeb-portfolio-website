...
export const FormTextarea = forwardRef<HTMLTextAreaElement, FormTextareaProps>(
  ({ label, required, error, helper, id, rows = 5, ...props }, ref) => {
    ...
    return (
      <div>
        ...
        <textarea
          ...
          className="w-full font-body text-[16px] rounded-xl transition-colors duration-160 focus:outline-none resize-none"
          style={{
            padding: '16px 20px',
